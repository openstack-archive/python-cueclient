...
from cueclient.tests import common
from cueclient.v1.cli import clusters


class TestListClusters(common.TestCueBase):
...
class TestCreateClusters(common.TestCueBase):
    ...
    def test_create_cluster_without_arg(self):
        pass